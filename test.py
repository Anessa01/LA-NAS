...
parser.add_argument('--load_path', type=str, default='Saved/model-20220410-091642', help='load model path')
...
def main():
    ...
    print('Test:\t avrbaccu={:.6f}\t acc={:.6f}\t missaccu={:.6f}'.format(avrbaccu, 1 - errsum_t / test_len, missaccu_t / test_len ))
